...
st.subheader("Mes diplômes")
diplômes = [
    "Brevet de technicien supérieur en géomatique obtenu au Centre d'Entrepreneuriat et de Développement Technique (CEDT-LEG15) avec la «mention Tres Bien»",
    "Baccalauréat en série L2 obtenu au Lycée de Bokhol avec la «mention Bien»",
    "Certificat en informatique et internet obtenu grâce au programme de la FORCE-N",
    "Certificat en secourisme obtenu a la Croix Rouge sénégalaise"
]
for item in diplômes :
        st.write(f"- {item}")
...
st.subheader("Mes réalisations académiques")
réalisations = [
    "Production de cartes(pédologiques des régions de Dakar,Thiés,Sédhiou...;de localisation des communes de Bokhol,Syer,Tivaoune Peulh...",
    "Levées topographiques",
    "Collecte de données(Massalikoul Djinan;Commune de Gueule Tapée-Fass-Colobane...",
    "Traitement de données en classe",
    "Développement d'applications en classe"
]
for item in réalisations :
        st.write(f"- {item}")
